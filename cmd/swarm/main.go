...
import (
	...
	"github.com/teamcents/go-cents/cmd/utils"
	"github.com/teamcents/go-cents/common"
	"github.com/teamcents/go-cents/console"
	"github.com/teamcents/go-cents/crypto"
	"github.com/teamcents/go-cents/internal/debug"
	"github.com/teamcents/go-cents/log"
	"github.com/teamcents/go-cents/node"
	"github.com/teamcents/go-cents/p2p/discover"
	"github.com/teamcents/go-cents/swarm"
	bzzapi "github.com/teamcents/go-cents/swarm/api"
	swarmmetrics "github.com/teamcents/go-cents/swarm/metrics"
	"github.com/teamcents/go-cents/swarm/tracing"
	sv "github.com/teamcents/go-cents/swarm/version"
...
var (
	...
	SwarmNetworkIdFlag = cli.IntFlag{
		Name:   "bzznetworkid",
		Usage:  "Network identifier (integer, default 252525=swarm testnet)",
...
func init() {
	...
	app.Copyright = "Copyright 2013-2016 The go-cents Authors"
