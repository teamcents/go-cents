...
//
// Detailed usage document and tutorial available on the go-cents Wiki page:
// https://github.com/teamcents/go-cents/wiki/Native-DApps:-Go-bindings-to-Ethereum-contracts
package bind
