...
import (
	...
	"github.com/teamcents/go-cents/accounts/abi"
...
func TestNewUnpacker(t *testing.T) {
	...
	testcases := []unpackTest{
		...
		}, { // https://github.com/teamcents/wiki/wiki/Ethereum-Contract-ABI#examples
...
[
	...
	for i, hexdata := range []string{
		...
		// From https://github.com/teamcents/wiki/wiki/Ethereum-Contract-ABI
