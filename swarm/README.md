...
Building Swarm requires Go (version 1.10 or later).
    ...
    go get -d github.com/teamcents/go-cents

    go install github.com/teamcents/go-cents/cmd/swarm
...
```
stateth --rm --grafana-dashboards-folder $GOPATH/src/github.com/teamcents/go-cents/swarm/grafana_dashboards --influxdb-database metrics
```
 ...
 * [Code review guidelines](https://github.com/teamcents/go-cents/wiki/Code-Review-Guidelines).
